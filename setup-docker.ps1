...
$envContent = "RESTAURANT_NAME=$restaurantName`nADMIN_NAME=$adminName`nADMIN_EMAIL=$adminEmail`nADMIN_PIN=$adminPin`nDUCKDNS_SUBDOMAIN=$duckdnsSub`nDUCKDNS_TOKEN=$duckdnsToken`nDOMAIN=$domain`nNODE_ENV=production`nPORT=3000`nDB_PATH=/app/data/shiftable.db"
