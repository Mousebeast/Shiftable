...
import { DAY_NAMES as DAYS, getNextWeekStart } from '../lib/week';
...
export default function Availability() {
  ...
  const [effectiveFrom, setEffectiveFrom] = useState(getNextWeekStart);
          ...
          <div>
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                disabled={effectiveFrom <= getNextWeekStart()}
