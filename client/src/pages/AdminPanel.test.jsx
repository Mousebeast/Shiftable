...
describe('AdminPanel — tabs', () => {
  it('renders four tab buttons', () => {
    ...
    expect(screen.getByRole('tab', { name: /email\/sms/i })).toBeInTheDocument();
...
describe('AdminPanel — Settings tab', () => {
  ...
  it('shows SMTP host field on the Email/SMS tab', () => {
    renderPanel();
    // SMTP moved out of Settings into its own Email/SMS tab.
    fireEvent.click(screen.getByRole('tab', { name: /email\/sms/i }));
