...
// InstallBanner reads restaurantName from useAuth, so it cannot render outside an
// AuthProvider. Mocking the hook matches how the page tests here handle it and
// keeps these cases focused on the install-prompt behaviour.
vi.mock('../hooks/useAuth', () => ({
  useAuth: () => ({ restaurantName: 'Test Place', user: null, logout: vi.fn() }),
}));
