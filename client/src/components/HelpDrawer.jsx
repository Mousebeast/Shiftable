    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Use the tiles below it to jump to the Schedule, Swaps, Time Off, and Availability pages.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'If no approved availability is on file, the scheduler may not be able to assign you shifts.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Once published, you can still make edits — start a new draft, make changes, and re-publish.',
        ],
      },
      {
