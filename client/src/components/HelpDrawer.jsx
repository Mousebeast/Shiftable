    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Apply Template — start from a named template you\'ve saved. Templates store the shift pattern without specific dates.',
          'All three options create a draft. Staff can\'t see it until you publish.',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          'Manage and delete templates from the Apply Template picker.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Staff Migration — export your staff configuration (groups, shifts, coverage rules, staff accounts) as a JSON package. Import it on a fresh installation to pre-populate a new instance. All imported staff start in unclaimed state with auto-generated claim links.',
        ],
      },
    ],
  },
