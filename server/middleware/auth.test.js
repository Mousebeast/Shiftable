...
// Seed users so getUserById succeeds — IDs 1, 2, 3 match the hardcoded tokens below
beforeAll(() => {
  seedUser(db, { email: 'alice@test.com', role: 'staff' });
  seedUser(db, { email: 'bob@test.com', role: 'manager' });
  seedUser(db, { email: 'carol@test.com', role: 'admin' });
});
