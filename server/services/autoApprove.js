...
const { dayIndexOfDateString } = require('./dates');
...
function checkAutoApprove(swap, db) {
  ...
  // day_of_week is an offset from the configured week start (0 = first day)
  const dayOfWeek = dayIndexOfDateString(shift.date);
