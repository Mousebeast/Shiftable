...
const { getTimeOffForUser, createTimeOffRequest, approveTimeOff, denyTimeOff, getPendingTimeOff, getTimeOffById } = require('../db/timeoff');
...
router.patch('/:id/approve', requireManager, (req, res) => {
  ...
  if (toRequest) {
    ...
    sendToUser(toRequest.user_id, { title: 'Time Off Approved', body: 'Your time-off request has been approved.', data: { url: '/timeoff' } }); // fire-and-forget
  }
