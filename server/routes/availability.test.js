...
describe('availability DB helpers', () => {
  ...
  it('createAvailabilityEntries inserts pending entries', () => {
    createAvailabilityEntries(
      user.id,
      [{ day_of_week: 0, start_time: '09:00', end_time: '17:00', is_blocked: 0, effective_from: '2026-06-08' }],
      db
    );
  ...
  it('creates multiple entries in one transaction', () => {
    createAvailabilityEntries(
      ...
      [
        { day_of_week: 0, start_time: '09:00', end_time: '17:00', is_blocked: 0, effective_from: '2026-06-08' },
        { day_of_week: 1, start_time: '10:00', end_time: '18:00', is_blocked: 0, effective_from: '2026-06-08' },
      ],
      db
    );
  ...
  it('denyAvailability updates status to denied', () => {
    createAvailabilityEntries(
      user.id,
      [{ day_of_week: 2, start_time: '08:00', end_time: '16:00', is_blocked: 0, effective_from: '2026-06-08' }],
      db
    );
    const rows = getAvailabilityForUser(user.id, db);
