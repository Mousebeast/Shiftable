...
func offerDockerInstall() error {
	err := zenity.Question(
		"Docker Desktop is not installed.\n\n"+
			...
			"Click 'Get Docker' to open the download page. After installing\n"+
			"and restarting your computer, run this wizard again.",
		zenity.Title(appTitle),
		zenity.OKLabel("Get Docker"),
		zenity.CancelLabel("Cancel"),
	)
	if err != nil {
		return err
	...
	_ = zenity.Info(
		"The Docker Desktop download page is now open in your browser.\n\n"+
